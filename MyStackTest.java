...
public class MyStackTest {
	...
	public void testPopStudent() {
		...
		try {
			assert (1.3 == doubleS.pop());
			assert (1.2 == doubleS.pop());
			assert (1.1 == doubleS.pop());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		...
		try {
			...
			assertEquals(true, doubleS.push(1.4));
			assertEquals(4, doubleS.size());
			assertEquals(true, doubleS.push(1.5));
	...
	public void testToStringStudent() throws StackOverflowException {
		//Use the doubleS for student tests
		 assertEquals("1.11.21.3", doubleS.toString());
		doubleS.push(1.4);
		assertEquals("1.11.21.31.4", doubleS.toString());
		doubleS.push(1.5);
		assertEquals("1.11.21.31.41.5", doubleS.toString());
	}
